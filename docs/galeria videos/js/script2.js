...
for (var i = 0; i < videos.length; i++) {
    ...
    const theVideo = video.querySelector("#myVideo");

    crearBotones(video);

    let btn_success = video.querySelector(".btn-success");
    let btn_warning = video.querySelector(".btn-warning");
    let btn_danger = video.querySelector(".btn-danger");
    let btn_info = video.querySelector(".btn-info");
    ...
    btn_info.addEventListener("click", () => {
        rewindVideo(theVideo);
    });
}

function crearBotones(video) {
    ...
    btn2.setAttribute('class', 'btn-warning');
    btn2.innerHTML = "Pause";

    var btn3 = document.createElement("button");
    btn3.setAttribute('class', 'btn-danger');
    btn3.innerHTML = "Stop";

    var btn4 = document.createElement("button");
    btn4.setAttribute('class', 'btn-info');
